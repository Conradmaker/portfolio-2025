...
export default function Footer() {
  return (
    <>
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto py-14 px-4 flex justify-between items-center antialiased">
        ...
        <ul className="flex gap-4 items-center">
          <li className="flex-col flex w-44 gap-4">
            ...
            <Link href="mailto:yhg0337@gmail.com">
              <p className="transition-all duration-300 group/link self-end flex items-center hover:bg-blue-600 bg-gray-100 p-1 rounded-full text-sm gap-1 pl-3 cursor-pointer">
          ...
          <li className="flex-col flex w-44 gap-4">
            ...
            <Link
              ...
              target="_blank"
              className="transition-all duration-300 group/link self-end flex items-center hover:bg-blue-600 bg-gray-100 p-1 rounded-full text-sm gap-1 pl-3 cursor-pointer"
            >
              <span className="group-hover/link:text-white transition-all duration-300">
                @conradmaker
              </span>
